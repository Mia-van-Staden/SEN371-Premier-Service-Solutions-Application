...
namespace SEN371_Project
{
    ...
    {
        string employeeName, employeeSurname, equipmentDetails, jobDescription, location;
        int activeTime;
        bool onTime;
        ...
        public JobsProgresscs(string employeeName, string employeeSurname, string equipmentDetails, string jobDescription, string location, int activeTime, bool onTime)
        {
