...
namespace SEN371_Project
{
    ...
    {
        string clientName, clientSurname, jobDescription, EmployeeName, EmployeeSurname, location, endDate;
        ...
        public HistoryJob(string clientName, string clientSurname, string jobDescription, string employeeName, string employeeSurname, int clientPhoneNumber, int performanceRating, string location, string endDate)
        {
